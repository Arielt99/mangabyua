    ...
    <div class="min-h-screen flex flew-row w-full bg-white">
        <nav class="h-screen flex flex-col w-64 bg-gray-50">
            ...
            <ul class="p-2 space-y-2 flex-1 overflow-auto" style="scrollbar-width: thin;">
                <li>
                    <inertia-link :href="route('admin.dashboard')" class="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200 rounded-lg">
                ...
                <li>
                    <inertia-link :href="route('admin.users.index')" class="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200 rounded-lg hover:text-gray-900">
                ...
                <li>
                    <form method="POST" @submit.prevent="logout" class="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200 rounded-lg hover:text-gray-900">
